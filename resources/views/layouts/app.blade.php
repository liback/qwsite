...
<head>
    ...
    <!--  Jquery (not from Bootstrap, but used by it) -->
                    ...
                    @else
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                {{ Auth::user()->name }} ({{ (Auth::user()->printRoles()) }}) <span class="caret"></span>
                            </a>
	...
	<div class="container">
	    <div class="row">
	        <div class="col-md-10 col-md-offset-1">
	        	@include('partials/_flashmessenger')
